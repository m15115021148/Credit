 ...
 * @date create at 2016年9月12日 下午4:40:32
 */
public class PreferencesUtil {
	 ...
	 * @param isFirst
	 *            true为是第一次登录
	 * @see #getFirstLogin(Context, String) 配套使用
	 * @return
	 */
	public static void isFirstLogin(Context context, String key, boolean isFirst) {
	 ...
	 * @return
	 */
	public static boolean getFirstLogin(Context context, String key) {
		SharedPreferences sp = context.getSharedPreferences(SP_LOGIN_PRIVATE,
				Context.MODE_PRIVATE);
	 ...
	 * @param str
	 *            true为是第一次登录
	 * @see #getStringTxt(Context, String) 配套使用
	 * @return
	 */
	public static void setStringTxt(Context context, String key, String str) {
		SharedPreferences sp = context.getSharedPreferences(SP_LOGIN_PRIVATE,
				Context.MODE_PRIVATE);
	 ...
	 * @return
	 */
	public static String getStringTxt(Context context, String key) {
		SharedPreferences sp = context.getSharedPreferences(SP_LOGIN_PRIVATE,
				Context.MODE_PRIVATE);
	...
	public static boolean deleteDataModel(Context context, String key) {
		SharedPreferences sp = context.getSharedPreferences(SP_MODEL_PRIVATE,
				Context.MODE_PRIVATE);
		return sp.edit().putString(key, null).commit();
	}
